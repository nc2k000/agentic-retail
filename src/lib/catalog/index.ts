...
export const CATALOG: Record<string, Product[]> = {
  ...
  'Pantry & Dry Goods': [
    ...
    // More Cereals & Breakfast - Weekly Essentials
    { sku: 'cereal-cinnamon-toast', name: 'Cinnamon Toast Crunch 16.8oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-honey-nut-cheerios', name: 'Honey Nut Cheerios 19.5oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-fruit-loops', name: 'Froot Loops 19.4oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-corn-flakes', name: 'Kellogg\'s Corn Flakes 24oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-rice-krispies', name: 'Rice Krispies 18oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-cocoa-puffs', name: 'Cocoa Puffs 19.5oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-special-k', name: 'Special K Original 18oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-chex', name: 'Chex Multi Bran 16oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-life', name: 'Life Original 18oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-granola', name: 'Nature Valley Oats & Honey Granola 16oz', price: 5.98, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-grape-nuts', name: 'Grape Nuts 29oz', price: 6.48, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-wheaties', name: 'Wheaties 15.6oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-captain-crunch', name: 'Cap\'n Crunch 20oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'cereal-apple-jacks', name: 'Apple Jacks 19.4oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🥣' },
    { sku: 'pop-tarts-strawberry', name: 'Pop-Tarts Strawberry 8ct', price: 3.98, category: 'Pantry & Dry Goods', image: '🍓' },
    { sku: 'pop-tarts-brown-sugar', name: 'Pop-Tarts Brown Sugar Cinnamon 8ct', price: 3.98, category: 'Pantry & Dry Goods', image: '🍰' },
    { sku: 'waffle-mix', name: 'Bisquick Waffle Mix 32oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🧇' },
    { sku: 'syrup-sugar-free', name: 'Mrs Butterworth Sugar Free Syrup 24oz', price: 5.98, category: 'Pantry & Dry Goods', image: '🍯' },
    { sku: 'honey', name: 'Sue Bee Clover Honey 12oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🍯' },
    { sku: 'peanut-butter-jif', name: 'Jif Creamy Peanut Butter 40oz', price: 7.98, category: 'Pantry & Dry Goods', image: '🥜' },
    { sku: 'peanut-butter-skippy', name: 'Skippy Creamy Peanut Butter 40oz', price: 7.98, category: 'Pantry & Dry Goods', image: '🥜' },
    { sku: 'peanut-butter-natural', name: 'Natural Peanut Butter 16oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🥜' },
    { sku: 'jelly-grape', name: 'Welch\'s Grape Jelly 32oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🍇' },
    { sku: 'jelly-strawberry', name: 'Smucker\'s Strawberry Jam 32oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🍓' },
    { sku: 'nutella', name: 'Nutella Hazelnut Spread 13oz', price: 5.98, category: 'Pantry & Dry Goods', image: '🍫' },

    // More Pasta Varieties
    { sku: 'pasta-rigatoni', name: 'Barilla Rigatoni 16oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🍝' },
    { sku: 'pasta-fettuccine', name: 'Barilla Fettuccine 16oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🍝' },
    { sku: 'pasta-angel-hair', name: 'Barilla Angel Hair 16oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🍝' },
    { sku: 'pasta-orzo', name: 'Barilla Orzo 16oz', price: 2.48, category: 'Pantry & Dry Goods', image: '🍝' },
    { sku: 'pasta-bow-tie', name: 'Barilla Farfalle (Bow Tie) 16oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🍝' },
    { sku: 'pasta-lasagna', name: 'Barilla Lasagna Noodles 16oz', price: 2.48, category: 'Pantry & Dry Goods', image: '🍝' },
    { sku: 'pasta-shells', name: 'Barilla Medium Shells 16oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🍝' },
    { sku: 'pasta-ziti', name: 'Barilla Ziti 16oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🍝' },
    { sku: 'pasta-gluten-free', name: 'Barilla Gluten Free Penne 12oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🍝' },
    { sku: 'ramen-noodles', name: 'Maruchan Ramen Chicken 12pk', price: 2.98, category: 'Pantry & Dry Goods', image: '🍜' },
    { sku: 'instant-noodles-cup', name: 'Cup Noodles Chicken 2.25oz 6pk', price: 4.98, category: 'Pantry & Dry Goods', image: '🍜' },

    // More Rice & Grains
    { sku: 'rice-wild-blend', name: 'Uncle Ben\'s Wild Rice Blend 8oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🍚' },
    { sku: 'rice-instant-brown', name: 'Minute Instant Brown Rice 28oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🍚' },
    { sku: 'rice-arborio', name: 'Arborio Risotto Rice 2lb', price: 6.98, category: 'Pantry & Dry Goods', image: '🍚' },
    { sku: 'rice-spanish', name: 'Goya Spanish Rice Mix 8oz', price: 2.48, category: 'Pantry & Dry Goods', image: '🍚' },
    { sku: 'rice-fried-mix', name: 'Minute Ready to Serve Fried Rice 8.8oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🍚' },
    { sku: 'barley', name: 'Pearl Barley 16oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🌾' },
    { sku: 'farro', name: 'Organic Farro 16oz', price: 5.98, category: 'Pantry & Dry Goods', image: '🌾' },
    { sku: 'bulgur', name: 'Bulgur Wheat 16oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🌾' },

    // More Canned Soups
    { sku: 'soup-cream-mushroom', name: 'Campbell\'s Cream of Mushroom', price: 1.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'soup-cream-chicken', name: 'Campbell\'s Cream of Chicken', price: 1.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'soup-vegetable', name: 'Campbell\'s Vegetable Soup', price: 1.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'soup-minestrone', name: 'Progresso Minestrone', price: 2.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'soup-clam-chowder', name: 'Progresso Clam Chowder', price: 2.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'soup-beef-barley', name: 'Progresso Beef Barley', price: 2.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'soup-split-pea', name: 'Campbell\'s Split Pea with Ham', price: 1.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'soup-french-onion', name: 'Campbell\'s French Onion Soup', price: 1.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'chili-canned', name: 'Hormel Chili with Beans 15oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'chili-no-beans', name: 'Hormel Chili No Beans 15oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🥫' },

    // More Canned Vegetables & Fruits
    { sku: 'peas-canned', name: 'Sweet Peas 15oz', price: 0.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'carrots-canned', name: 'Sliced Carrots 14.5oz', price: 0.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'beets-canned', name: 'Sliced Beets 15oz', price: 1.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'asparagus-canned', name: 'Cut Asparagus Spears 15oz', price: 2.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'mushrooms-canned', name: 'Mushroom Pieces & Stems 7oz', price: 1.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'olives-black', name: 'Black Olives Sliced 6oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🫒' },
    { sku: 'olives-green', name: 'Green Olives Stuffed 10oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🫒' },
    { sku: 'pickles-dill', name: 'Vlasic Dill Pickles 46oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🥒' },
    { sku: 'pickles-sweet', name: 'Mt Olive Sweet Pickles 16oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🥒' },
    { sku: 'relish-sweet', name: 'Heinz Sweet Relish 10oz', price: 2.48, category: 'Pantry & Dry Goods', image: '🥒' },
    { sku: 'jalapen os-canned', name: 'Sliced Jalapeños 12oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🌶️' },
    { sku: 'artichoke-hearts', name: 'Artichoke Hearts 14oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'peaches-canned', name: 'Del Monte Sliced Peaches 29oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🍑' },
    { sku: 'pears-canned', name: 'Del Monte Pear Halves 29oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🍐' },
    { sku: 'fruit-cocktail', name: 'Dole Fruit Cocktail 15oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'pineapple-canned', name: 'Dole Pineapple Chunks 20oz', price: 2.48, category: 'Pantry & Dry Goods', image: '🍍' },
    { sku: 'mandarin-oranges', name: 'Dole Mandarin Oranges 15oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🍊' },
    { sku: 'applesauce', name: 'Mott\'s Applesauce 6pk', price: 3.48, category: 'Pantry & Dry Goods', image: '🍎' },
    { sku: 'cranberry-sauce', name: 'Ocean Spray Cranberry Sauce 14oz', price: 2.48, category: 'Pantry & Dry Goods', image: '🥫' },

    // International - Asian
    { sku: 'teriyaki-sauce', name: 'Kikkoman Teriyaki Sauce 20oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'hoisin-sauce', name: 'Lee Kum Kee Hoisin Sauce 20oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'sriracha', name: 'Huy Fong Sriracha 17oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🌶️' },
    { sku: 'sweet-chili-sauce', name: 'Thai Sweet Chili Sauce 10oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'fish-sauce', name: 'Thai Kitchen Fish Sauce 7oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'sesame-oil', name: 'Kadoya Sesame Oil 11oz', price: 6.98, category: 'Pantry & Dry Goods', image: '🧴' },
    { sku: 'rice-vinegar', name: 'Marukan Rice Vinegar 12oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🧴' },
    { sku: 'coconut-milk', name: 'Thai Kitchen Coconut Milk 13.66oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🥥' },
    { sku: 'curry-paste', name: 'Thai Kitchen Red Curry Paste 4oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'miso-paste', name: 'Miko Brand Miso Paste 16oz', price: 5.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'rice-noodles', name: 'Thai Kitchen Rice Noodles 14oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🍜' },
    { sku: 'panko-bread-crumbs', name: 'Kikkoman Panko Bread Crumbs 8oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🍞' },
    { sku: 'wasabi-paste', name: 'S&B Wasabi Paste 1.52oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🟢' },
    { sku: 'seaweed-nori', name: 'Nori Seaweed Sheets 50pk', price: 8.98, category: 'Pantry & Dry Goods', image: '🟢' },

    // International - Mexican
    { sku: 'salsa-mild', name: 'Pace Chunky Salsa Mild 16oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🌶️' },
    { sku: 'salsa-medium', name: 'Pace Chunky Salsa Medium 16oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🌶️' },
    { sku: 'salsa-hot', name: 'Pace Chunky Salsa Hot 16oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🌶️' },
    { sku: 'salsa-verde', name: 'Herdez Salsa Verde 16oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🟢' },
    { sku: 'enchilada-sauce-red', name: 'Old El Paso Red Enchilada Sauce 10oz', price: 2.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'enchilada-sauce-green', name: 'Las Palmas Green Chile Enchilada 10oz', price: 2.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'taco-seasoning', name: 'Old El Paso Taco Seasoning', price: 1.48, category: 'Pantry & Dry Goods', image: '🌮' },
    { sku: 'taco-shells', name: 'Old El Paso Taco Shells 12ct', price: 3.48, category: 'Pantry & Dry Goods', image: '🌮' },
    { sku: 'tortillas-flour', name: 'Mission Flour Tortillas 10ct', price: 3.98, category: 'Pantry & Dry Goods', image: '🫓' },
    { sku: 'tortillas-corn', name: 'Mission Corn Tortillas 30ct', price: 3.48, category: 'Pantry & Dry Goods', image: '🫓' },
    { sku: 'tortilla-chips', name: 'Mission Tortilla Chips 13oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🌮' },
    { sku: 'queso-dip', name: 'Tostitos Queso Dip 15oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🧀' },
    { sku: 'guacamole', name: 'Wholly Guacamole 12oz', price: 5.98, category: 'Pantry & Dry Goods', image: '🥑' },
    { sku: 'chiles-green', name: 'Ortega Diced Green Chiles 4oz', price: 1.48, category: 'Pantry & Dry Goods', image: '🌶️' },
    { sku: 'chipotle-peppers', name: 'La Costeña Chipotle Peppers 7oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🌶️' },

    // International - Italian
    { sku: 'capers', name: 'Mediterranean Capers 3.5oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🫒' },
    { sku: 'sun-dried-tomatoes', name: 'Sun Dried Tomatoes in Oil 8oz', price: 5.98, category: 'Pantry & Dry Goods', image: '🍅' },
    { sku: 'roasted-red-peppers', name: 'Roasted Red Peppers 12oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🫑' },
    { sku: 'balsamic-vinegar', name: 'Pompeian Balsamic Vinegar 16oz', price: 5.98, category: 'Pantry & Dry Goods', image: '🧴' },
    { sku: 'wine-vinegar-red', name: 'Red Wine Vinegar 16oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🧴' },
    { sku: 'italian-seasoning', name: 'McCormick Italian Seasoning 0.75oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'basil-dried', name: 'McCormick Basil Leaves 0.75oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'rosemary-dried', name: 'McCormick Rosemary Leaves 0.75oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'thyme-dried', name: 'McCormick Thyme Leaves 0.75oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🧂' },

    // More Spices & Seasonings
    { sku: 'bay-leaves', name: 'McCormick Bay Leaves 0.12oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'ginger-ground', name: 'McCormick Ground Ginger 1.5oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'nutmeg-ground', name: 'McCormick Ground Nutmeg 1.1oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'allspice', name: 'McCormick Allspice 1.75oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'cloves-ground', name: 'McCormick Ground Cloves 0.9oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'cayenne-pepper', name: 'McCormick Cayenne Pepper 1.75oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'turmeric', name: 'McCormick Ground Turmeric 1.75oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'coriander', name: 'McCormick Ground Coriander 1.25oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'parsley-flakes', name: 'McCormick Parsley Flakes 0.31oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'dill-weed', name: 'McCormick Dill Weed 0.75oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'celery-salt', name: 'McCormick Celery Salt 4oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'seasoned-salt', name: 'Lawry\'s Seasoned Salt 8oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'lemon-pepper', name: 'McCormick Lemon Pepper 8.75oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'cajun-seasoning', name: 'Tony Chachere\'s Cajun Seasoning 8oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'ranch-seasoning', name: 'Hidden Valley Ranch Seasoning Mix', price: 2.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'taco-seasoning-gv', name: 'GV Taco Seasoning 4pk', price: 2.48, category: 'Pantry & Dry Goods', image: '🌮' },
    { sku: 'gravy-mix-brown', name: 'McCormick Brown Gravy Mix', price: 1.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'gravy-mix-turkey', name: 'McCormick Turkey Gravy Mix', price: 1.48, category: 'Pantry & Dry Goods', image: '🥫' },

    // More Condiments & Sauces
    { sku: 'worcestershire', name: 'Lea & Perrins Worcestershire 10oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'steak-sauce', name: 'A1 Original Steak Sauce 10oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'cocktail-sauce', name: 'Heinz Cocktail Sauce 12oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'tartar-sauce', name: 'Kraft Tartar Sauce 12oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'horseradish', name: 'Kraft Horseradish 5oz', price: 3.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'thousand-island', name: 'Kraft Thousand Island 16oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'caesar-dressing', name: 'Ken\'s Caesar Dressing 16oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'blue-cheese-dressing', name: 'Kraft Blue Cheese Dressing 16oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'balsamic-dressing', name: 'Newman\'s Balsamic Vinaigrette 16oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'vinaigrette-italian', name: 'Kraft Balsamic Vinaigrette 16oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🥫' },

    // More Baking
    { sku: 'cake-mix-chocolate', name: 'Betty Crocker Chocolate Cake Mix', price: 2.48, category: 'Pantry & Dry Goods', image: '🍰' },
    { sku: 'cake-mix-vanilla', name: 'Betty Crocker Yellow Cake Mix', price: 2.48, category: 'Pantry & Dry Goods', image: '🍰' },
    { sku: 'brownie-mix', name: 'Ghirardelli Brownie Mix 18oz', price: 4.98, category: 'Pantry & Dry Goods', image: '🍫' },
    { sku: 'muffin-mix-blueberry', name: 'Jiffy Blueberry Muffin Mix 7oz', price: 1.48, category: 'Pantry & Dry Goods', image: '🧁' },
    { sku: 'frosting-chocolate', name: 'Betty Crocker Chocolate Frosting 16oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🍫' },
    { sku: 'frosting-vanilla', name: 'Betty Crocker Vanilla Frosting 16oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🍰' },
    { sku: 'cocoa-powder', name: 'Hershey\'s Cocoa Powder 8oz', price: 5.48, category: 'Pantry & Dry Goods', image: '🍫' },
    { sku: 'corn-syrup', name: 'Karo Light Corn Syrup 16oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🍯' },
    { sku: 'molasses', name: 'Grandma\'s Molasses 12oz', price: 4.48, category: 'Pantry & Dry Goods', image: '🍯' },
    { sku: 'shortening', name: 'Crisco All-Vegetable Shortening 48oz', price: 7.98, category: 'Pantry & Dry Goods', image: '🧴' },
    { sku: 'sweetened-condensed-milk', name: 'Eagle Brand Sweetened Condensed 14oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'evaporated-milk', name: 'Carnation Evaporated Milk 12oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🥫' },
    { sku: 'yeast', name: 'Fleischmann\'s Active Dry Yeast 3pk', price: 5.48, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'corn-starch', name: 'Argo Corn Starch 16oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🧂' },
    { sku: 'gelatin', name: 'Jell-O Strawberry Gelatin 6oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🍓' },
    { sku: 'pudding-mix-chocolate', name: 'Jell-O Chocolate Pudding Mix 5.9oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🍫' },
    { sku: 'pudding-mix-vanilla', name: 'Jell-O Vanilla Pudding Mix 5.1oz', price: 1.98, category: 'Pantry & Dry Goods', image: '🍰' },
    { sku: 'pie-filling-apple', name: 'Comstock Apple Pie Filling 21oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🍎' },
    { sku: 'pie-filling-cherry', name: 'Comstock Cherry Pie Filling 21oz', price: 3.98, category: 'Pantry & Dry Goods', image: '🍒' },
    { sku: 'sprinkles', name: 'Rainbow Sprinkles 4oz', price: 2.98, category: 'Pantry & Dry Goods', image: '🌈' },
  ],
  ...
  'Snacks': [
    ...
    { sku: 'popcorn-kernels', name: 'Orville Redenbacher Kernels 30oz', price: 5.98, category: 'Snacks', image: '🍿' },
    { sku: 'popcorn-ready-eat', name: 'Smartfood White Cheddar 7oz', price: 4.48, category: 'Snacks', image: '🍿' },

    // More Cookies & Baked Snacks
    { sku: 'cookies-fig-newtons', name: 'Fig Newtons 10oz', price: 4.48, category: 'Snacks', image: '🍪' },
    { sku: 'cookies-vienna-fingers', name: 'Vienna Fingers 14.2oz', price: 3.98, category: 'Snacks', image: '🍪' },
    { sku: 'cookies-girl-scouts-thin-mints', name: 'Keebler Grasshopper 10oz', price: 4.48, category: 'Snacks', image: '🍪' },
    { sku: 'cookies-ginger-snaps', name: 'Nabisco Ginger Snaps 16oz', price: 3.98, category: 'Snacks', image: '🍪' },
    { sku: 'cookies-animal-crackers', name: 'Barnum\'s Animal Crackers 12oz', price: 3.48, category: 'Snacks', image: '🍪' },
    { sku: 'cookies-lorna-doone', name: 'Lorna Doone Shortbread 10oz', price: 4.48, category: 'Snacks', image: '🍪' },
    { sku: 'cookies-wafer', name: 'Voortman Sugar Free Wafers 9oz', price: 3.98, category: 'Snacks', image: '🍪' },
    { sku: 'brownie-bites', name: 'Little Bites Brownies 5pk', price: 4.48, category: 'Snacks', image: '🍫' },
    { sku: 'muffin-bites', name: 'Little Bites Blueberry Muffins 5pk', price: 4.48, category: 'Snacks', image: '🧁' },
    { sku: 'honey-buns', name: 'Hostess Honey Buns 6pk', price: 4.98, category: 'Snacks', image: '🍩' },
    { sku: 'twinkies', name: 'Hostess Twinkies 10pk', price: 5.48, category: 'Snacks', image: '🍰' },
    { sku: 'ho-hos', name: 'Hostess Ho Hos 10pk', price: 5.48, category: 'Snacks', image: '🍫' },
    { sku: 'ding-dongs', name: 'Hostess Ding Dongs 10pk', price: 5.48, category: 'Snacks', image: '🍫' },
    { sku: 'swiss-rolls', name: 'Little Debbie Swiss Rolls 12pk', price: 4.98, category: 'Snacks', image: '🍫' },
    { sku: 'oatmeal-cream-pies', name: 'Little Debbie Oatmeal Cream Pies 12pk', price: 4.98, category: 'Snacks', image: '🍪' },
    { sku: 'cosmic-brownies', name: 'Little Debbie Cosmic Brownies 12pk', price: 4.98, category: 'Snacks', image: '🍫' },
    { sku: 'zebra-cakes', name: 'Little Debbie Zebra Cakes 10pk', price: 4.98, category: 'Snacks', image: '🍰' },

    // More Candy
    { sku: 'candy-snickers', name: 'Snickers Fun Size 10.59oz', price: 6.98, category: 'Snacks', image: '🍫' },
    { sku: 'candy-kit-kat', name: 'Kit Kat Miniatures 10oz', price: 6.98, category: 'Snacks', image: '🍫' },
    { sku: 'candy-hersheys', name: 'Hershey\'s Miniatures 10.35oz', price: 6.98, category: 'Snacks', image: '🍫' },
    { sku: 'candy-milky-way', name: 'Milky Way Fun Size 10.65oz', price: 6.98, category: 'Snacks', image: '🍫' },
    { sku: 'candy-three-musketeers', name: '3 Musketeers Fun Size 10.65oz', price: 6.98, category: 'Snacks', image: '🍫' },
    { sku: 'candy-almond-joy', name: 'Almond Joy Snack Size 11.3oz', price: 6.98, category: 'Snacks', image: '🥥' },
    { sku: 'candy-mounds', name: 'Mounds Snack Size 10.5oz', price: 6.98, category: 'Snacks', image: '🥥' },
    { sku: 'candy-jolly-ranchers', name: 'Jolly Ranchers Hard Candy 14oz', price: 4.48, category: 'Snacks', image: '🍬' },
    { sku: 'candy-life-savers', name: 'Life Savers 5 Flavors 6.25oz', price: 3.98, category: 'Snacks', image: '🍬' },
    { sku: 'candy-starburst-fave-reds', name: 'Starburst Fave Reds 15.6oz', price: 5.48, category: 'Snacks', image: '🔴' },
    { sku: 'candy-sour-patch-kids', name: 'Sour Patch Kids 12oz', price: 4.98, category: 'Snacks', image: '👶' },
    { sku: 'candy-swedish-fish', name: 'Swedish Fish 14oz', price: 4.48, category: 'Snacks', image: '🐟' },
    { sku: 'candy-haribo-gummy-bears', name: 'Haribo Goldbears 10oz', price: 4.98, category: 'Snacks', image: '🐻' },
    { sku: 'candy-mike-and-ike', name: 'Mike and Ike Original 10oz', price: 3.98, category: 'Snacks', image: '🌈' },
    { sku: 'candy-dots', name: 'Dots Gumdrops 12oz', price: 3.98, category: 'Snacks', image: '🟡' },
    { sku: 'candy-milk-duds', name: 'Milk Duds 10oz', price: 4.98, category: 'Snacks', image: '🍫' },
    { sku: 'candy-rolo', name: 'Rolo Chewy Caramels 11oz', price: 5.98, category: 'Snacks', image: '🍫' },
    { sku: 'candy-whoppers', name: 'Whoppers Malted Milk Balls 12oz', price: 4.98, category: 'Snacks', image: '🍫' },
    { sku: 'candy-york-peppermint', name: 'York Peppermint Patties 11.4oz', price: 5.98, category: 'Snacks', image: '🍫' },
    { sku: 'candy-tootsie-rolls', name: 'Tootsie Rolls Midgees 12oz', price: 4.48, category: 'Snacks', image: '🍫' },

    // Salty Snacks Expansion
    { sku: 'chips-kettle-cooked', name: 'Kettle Brand Sea Salt 8.5oz', price: 5.48, category: 'Snacks', image: '🥔' },
    { sku: 'chips-ruffles', name: 'Ruffles Original 13oz', price: 4.98, category: 'Snacks', image: '🥔' },
    { sku: 'chips-wavy-lays', name: 'Wavy Lay\'s Original 10oz', price: 4.98, category: 'Snacks', image: '🥔' },
    { sku: 'chips-sunchips', name: 'SunChips Harvest Cheddar 10oz', price: 5.48, category: 'Snacks', image: '🌽' },
    { sku: 'chips-fritos', name: 'Fritos Original Corn Chips 10oz', price: 4.98, category: 'Snacks', image: '🌽' },
    { sku: 'chips-cheez-it', name: 'Cheez-It Original 12.4oz', price: 5.48, category: 'Snacks', image: '🧀' },
    { sku: 'chips-cheese-nips', name: 'Better Cheddars 8oz', price: 4.48, category: 'Snacks', image: '🧀' },
    { sku: 'crackers-townhouse', name: 'Town House Original 13.8oz', price: 4.48, category: 'Snacks', image: '🧈' },
    { sku: 'crackers-club', name: 'Club Crackers 13.7oz', price: 4.48, category: 'Snacks', image: '🧈' },
    { sku: 'crackers-saltine', name: 'Premium Saltine Crackers 16oz', price: 3.48, category: 'Snacks', image: '🧈' },
    { sku: 'crackers-graham', name: 'Honey Maid Graham Crackers 14.4oz', price: 4.48, category: 'Snacks', image: '🍯' },
    { sku: 'pretzels-rods', name: 'Snyder\'s Pretzel Rods 12oz', price: 4.48, category: 'Snacks', image: '🥨' },
    { sku: 'pretzels-sticks', name: 'Rold Gold Pretzel Sticks 16oz', price: 3.98, category: 'Snacks', image: '🥨' },
    { sku: 'pretzels-honey-mustard', name: 'Snyder\'s Honey Mustard Pretzels 12oz', price: 4.98, category: 'Snacks', image: '🥨' },
    { sku: 'chex-mix', name: 'Chex Mix Traditional 15oz', price: 5.48, category: 'Snacks', image: '🥨' },
    { sku: 'gardetto', name: 'Gardetto\'s Original Recipe 14.5oz', price: 5.48, category: 'Snacks', image: '🥨' },
    { sku: 'combos', name: 'Combos Cheddar Cheese Pretzel 12.6oz', price: 5.98, category: 'Snacks', image: '🥨' },
    { sku: 'bugles', name: 'Bugles Original 14.5oz', price: 4.98, category: 'Snacks', image: '📯' },
    { sku: 'funyuns', name: 'Funyuns Onion Rings 6oz', price: 4.48, category: 'Snacks', image: '🧅' },
    { sku: 'munchies', name: 'Munchies Snack Mix 8oz', price: 4.98, category: 'Snacks', image: '🥨' },

    // Jerky & Meat Snacks
    { sku: 'jerky-beef-original', name: 'Jack Link\'s Original Beef Jerky 9oz', price: 12.98, category: 'Snacks', image: '🥩' },
    { sku: 'jerky-beef-teriyaki', name: 'Jack Link\'s Teriyaki Beef Jerky 9oz', price: 12.98, category: 'Snacks', image: '🥩' },
    { sku: 'jerky-beef-peppered', name: 'Jack Link\'s Peppered Beef Jerky 9oz', price: 12.98, category: 'Snacks', image: '🥩' },
    { sku: 'jerky-turkey', name: 'Jack Link\'s Turkey Jerky 9oz', price: 12.98, category: 'Snacks', image: '🦃' },
    { sku: 'slim-jims', name: 'Slim Jim Original Smoked Snack Sticks 26pk', price: 11.98, category: 'Snacks', image: '🌭' },
    { sku: 'beef-sticks', name: 'Old Wisconsin Beef Snack Sticks 6oz', price: 8.98, category: 'Snacks', image: '🌭' },
    { sku: 'pepperoni-snack', name: 'Hormel Pepperoni Original 5oz', price: 4.98, category: 'Snacks', image: '🍕' },

    // More Healthy Snacks
    { sku: 'pistachios-roasted', name: 'Wonderful Pistachios 16oz', price: 12.98, category: 'Snacks', image: '🥜' },
    { sku: 'peanuts-dry-roasted', name: 'Planters Dry Roasted Peanuts 16oz', price: 6.98, category: 'Snacks', image: '🥜' },
    { sku: 'peanuts-honey-roasted', name: 'Planters Honey Roasted Peanuts 16oz', price: 6.98, category: 'Snacks', image: '🥜' },
    { sku: 'sunflower-seeds', name: 'David Sunflower Seeds 14.5oz', price: 5.98, category: 'Snacks', image: '🌻' },
    { sku: 'pumpkin-seeds', name: 'Planters Pumpkin Seeds 5oz', price: 4.98, category: 'Snacks', image: '🎃' },
    { sku: 'veggie-straws', name: 'Sensible Portions Veggie Straws 12oz', price: 4.98, category: 'Snacks', image: '🥕' },
    { sku: 'veggie-chips', name: 'Terra Vegetable Chips 6.8oz', price: 5.48, category: 'Snacks', image: '🥕' },
    { sku: 'fruit-snacks-welch', name: 'Welch\'s Fruit Snacks 22oz', price: 6.98, category: 'Snacks', image: '🍇' },
    { sku: 'fruit-snacks-motts', name: 'Mott\'s Fruit Snacks 22oz', price: 6.98, category: 'Snacks', image: '🍎' },
    { sku: 'applesauce-pouches', name: 'GoGo squeeZ Apple 12pk', price: 7.98, category: 'Snacks', image: '🍎' },
    { sku: 'fruit-pouches', name: 'Dole Fruit Squish\'ems 16pk', price: 9.98, category: 'Snacks', image: '🍓' },
    { sku: 'dried-cranberries', name: 'Ocean Spray Craisins 24oz', price: 8.98, category: 'Snacks', image: '🔴' },
    { sku: 'dried-apricots', name: 'Mariani Dried Apricots 16oz', price: 9.98, category: 'Snacks', image: '🍑' },
    { sku: 'dried-mango', name: 'Philippine Brand Dried Mango 20oz', price: 11.98, category: 'Snacks', image: '🥭' },
    { sku: 'raisins-boxes', name: 'Sun-Maid Raisins 12 boxes', price: 3.98, category: 'Snacks', image: '🍇' },
    { sku: 'protein-bar-clif', name: 'Clif Protein Bar Variety 12pk', price: 14.98, category: 'Snacks', image: '💪' },
    { sku: 'protein-bar-quest', name: 'Quest Protein Bars 12pk', price: 24.98, category: 'Snacks', image: '💪' },
    { sku: 'protein-bar-rxbar', name: 'RXBAR Protein Bars 12pk', price: 18.98, category: 'Snacks', image: '💪' },
    { sku: 'granola-bars-chewy', name: 'Quaker Chewy Granola Bars 18pk', price: 6.98, category: 'Snacks', image: '🌾' },
    { sku: 'fiber-one-bars', name: 'Fiber One Brownies 12pk', price: 6.98, category: 'Snacks', image: '🍫' },
  ],
  ...
  'Beverages': [
    ...
    { sku: 'monster-ultra', name: 'Monster Ultra Zero 16oz', price: 2.48, category: 'Beverages', image: '🥤' },
    { sku: 'rockstar-energy', name: 'Rockstar Original 16oz', price: 2.48, category: 'Beverages', image: '🥤' },
    { sku: '5-hour-energy', name: '5-Hour Energy Berry 6pk', price: 12.98, category: 'Beverages', image: '⚡' },
    { sku: 'celsius', name: 'Celsius Sparkling Orange 12oz', price: 2.98, category: 'Beverages', image: '🥤' },

    // More Coffee & Tea
    { sku: 'coffee-maxwell-house', name: 'Maxwell House Original 30.6oz', price: 10.98, category: 'Beverages', image: '☕' },
    { sku: 'coffee-dunkin', name: 'Dunkin\' Donuts Original 12oz', price: 9.98, category: 'Beverages', image: '☕' },
    { sku: 'coffee-peets', name: 'Peet\'s Major Dickason\'s 12oz', price: 12.98, category: 'Beverages', image: '☕' },
    { sku: 'coffee-kcups-donut-shop', name: 'Green Mountain K-Cups 32pk', price: 19.98, category: 'Beverages', image: '☕' },
    { sku: 'coffee-kcups-french-vanilla', name: 'French Vanilla K-Cups 32pk', price: 19.98, category: 'Beverages', image: '☕' },
    { sku: 'coffee-kcups-hazelnut', name: 'Hazelnut K-Cups 32pk', price: 19.98, category: 'Beverages', image: '☕' },
    { sku: 'coffee-espresso-beans', name: 'Lavazza Espresso Italiano 8.8oz', price: 9.98, category: 'Beverages', image: '☕' },
    { sku: 'coffee-cold-brew', name: 'Starbucks Cold Brew 48oz', price: 6.98, category: 'Beverages', image: '☕' },
    { sku: 'tea-chamomile', name: 'Celestial Chamomile Tea 20ct', price: 4.48, category: 'Beverages', image: '🍵' },
    { sku: 'tea-earl-grey', name: 'Twinings Earl Grey 40ct', price: 6.98, category: 'Beverages', image: '🍵' },
    { sku: 'tea-english-breakfast', name: 'Twinings English Breakfast 40ct', price: 6.98, category: 'Beverages', image: '🍵' },
    { sku: 'tea-peppermint', name: 'Bigelow Peppermint Tea 28ct', price: 4.98, category: 'Beverages', image: '🍵' },
    { sku: 'tea-lemon-ginger', name: 'Bigelow Lemon Ginger 18ct', price: 4.98, category: 'Beverages', image: '🍵' },
    { sku: 'tea-sweet-tea', name: 'Luzianne Sweet Tea 24ct', price: 5.98, category: 'Beverages', image: '🍵' },
    { sku: 'tea-arizona', name: 'Arizona Green Tea 23oz 6pk', price: 6.98, category: 'Beverages', image: '🍵' },
    { sku: 'tea-snapple-peach', name: 'Snapple Peach Tea 16oz 6pk', price: 6.98, category: 'Beverages', image: '🍑' },

    // More Soda Varieties
    { sku: 'fanta-orange', name: 'Fanta Orange 12pk 12oz', price: 7.98, category: 'Beverages', image: '🥤' },
    { sku: 'crush-orange', name: 'Crush Orange 2L', price: 2.48, category: 'Beverages', image: '🥤' },
    { sku: 'sunkist', name: 'Sunkist Orange 12pk', price: 7.98, category: 'Beverages', image: '🥤' },
    { sku: 'a-w-root-beer', name: 'A&W Root Beer 12pk 12oz', price: 7.98, category: 'Beverages', image: '🥤' },
    { sku: 'mug-root-beer', name: 'Mug Root Beer 2L', price: 2.48, category: 'Beverages', image: '🥤' },
    { sku: 'barqs-root-beer', name: 'Barq\'s Root Beer 12pk', price: 7.98, category: 'Beverages', image: '🥤' },
    { sku: '7-up', name: '7UP Lemon Lime 12pk 12oz', price: 7.98, category: 'Beverages', image: '🥤' },
    { sku: 'sierra-mist', name: 'Sierra Mist 2L', price: 2.48, category: 'Beverages', image: '🥤' },
    { sku: 'coke-zero', name: 'Coca-Cola Zero Sugar 12pk', price: 7.98, category: 'Beverages', image: '🥤' },
    { sku: 'diet-coke', name: 'Diet Coke 12pk 12oz', price: 7.98, category: 'Beverages', image: '🥤' },
    { sku: 'diet-pepsi', name: 'Diet Pepsi 12pk 12oz', price: 7.98, category: 'Beverages', image: '🥤' },
    { sku: 'coke-cherry', name: 'Cherry Coca-Cola 12pk', price: 7.98, category: 'Beverages', image: '🍒' },
    { sku: 'pepsi-wild-cherry', name: 'Pepsi Wild Cherry 12pk', price: 7.98, category: 'Beverages', image: '🍒' },
    { sku: 'mountain-dew-code-red', name: 'Mountain Dew Code Red 12pk', price: 7.98, category: 'Beverages', image: '🥤' },
    { sku: 'mountain-dew-voltage', name: 'Mountain Dew Voltage 12pk', price: 7.98, category: 'Beverages', image: '🥤' },

    // More Juices
    { sku: 'juice-orange-pulp-free', name: 'Tropicana No Pulp 52oz', price: 4.98, category: 'Beverages', image: '🍊' },
    { sku: 'juice-grapefruit', name: 'Ocean Spray Grapefruit 64oz', price: 4.98, category: 'Beverages', image: '🍊' },
    { sku: 'juice-pineapple', name: 'Dole Pineapple Juice 46oz', price: 3.98, category: 'Beverages', image: '🍍' },
    { sku: 'juice-tomato', name: 'Campbell\'s Tomato Juice 64oz', price: 4.48, category: 'Beverages', image: '🍅' },
    { sku: 'juice-v8', name: 'V8 Original 64oz', price: 5.48, category: 'Beverages', image: '🍅' },
    { sku: 'juice-prune', name: 'Sunsweet Prune Juice 64oz', price: 5.98, category: 'Beverages', image: '🫐' },
    { sku: 'juice-fruit-punch', name: 'Hawaiian Punch Fruit Juicy Red 128oz', price: 3.98, category: 'Beverages', image: '🥤' },
    { sku: 'juice-capri-sun', name: 'Capri Sun Fruit Punch 10pk', price: 4.98, category: 'Beverages', image: '🧃' },
    { sku: 'juice-kool-aid', name: 'Kool-Aid Jammers Cherry 10pk', price: 3.98, category: 'Beverages', image: '🧃' },
    { sku: 'juice-hi-c', name: 'Hi-C Fruit Punch 10pk', price: 4.48, category: 'Beverages', image: '🧃' },
    { sku: 'juice-apple-martinelli', name: 'Martinelli\'s Apple Juice 10oz 8pk', price: 9.98, category: 'Beverages', image: '🍎' },

    // Specialty & Health Drinks
    { sku: 'kombucha-gingerade', name: 'GT\'s Kombucha Gingerade 16oz', price: 3.98, category: 'Beverages', image: '🍵' },
    { sku: 'kombucha-trilogy', name: 'GT\'s Kombucha Trilogy 16oz', price: 3.98, category: 'Beverages', image: '🍵' },
    { sku: 'vitamin-water-xxx', name: 'Vitaminwater XXX 20oz', price: 1.98, category: 'Beverages', image: '💧' },
    { sku: 'vitamin-water-power-c', name: 'Vitaminwater Power-C 20oz', price: 1.98, category: 'Beverages', image: '💧' },
    { sku: 'propel-water', name: 'Propel Electrolyte Water 12pk', price: 8.98, category: 'Beverages', image: '💧' },
    { sku: 'smartwater', name: 'Smartwater 1L 6pk', price: 9.98, category: 'Beverages', image: '💧' },
    { sku: 'fiji-water', name: 'Fiji Water 500ml 6pk', price: 11.98, category: 'Beverages', image: '💧' },
    { sku: 'essentia-water', name: 'Essentia Alkaline Water 1L 6pk', price: 12.98, category: 'Beverages', image: '💧' },
    { sku: 'coconut-water', name: 'Vita Coco Coconut Water 16.9oz 12pk', price: 19.98, category: 'Beverages', image: '🥥' },
    { sku: 'aloe-vera-drink', name: 'OKF Aloe Vera Drink 16.9oz 6pk', price: 8.98, category: 'Beverages', image: '🌿' },
    { sku: 'ensure-vanilla', name: 'Ensure Original Vanilla 8oz 6pk', price: 12.98, category: 'Beverages', image: '🥤' },
    { sku: 'boost-chocolate', name: 'Boost Original Chocolate 8oz 6pk', price: 11.98, category: 'Beverages', image: '🍫' },
    { sku: 'muscle-milk-chocolate', name: 'Muscle Milk Chocolate 14oz 4pk', price: 9.98, category: 'Beverages', image: '💪' },
    { sku: 'core-power-vanilla', name: 'Core Power Vanilla 14oz 4pk', price: 9.98, category: 'Beverages', image: '💪' },
    { sku: 'bodyarmor-fruit-punch', name: 'BodyArmor Fruit Punch 16oz 8pk', price: 12.98, category: 'Beverages', image: '🥤' },
  ],
